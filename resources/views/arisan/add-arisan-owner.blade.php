...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <!-- Account -->
                <form method="POST" action="{{ route('processAddArisanOwner') }}" enctype="multipart/form-data" novalidate>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control @error('nama_arisan') is-invalid @enderror" type="text"
                                    id="nama_arisan" name="nama_arisan" value="{{ old('nama_arisan') }}" autofocus required
                                    placeholder="contoh: Arisan Mobil Semanggi" />
                                @error('nama_arisan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

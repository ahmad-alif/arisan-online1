    ...
    <main id="main" class="main">
        ...
        <div class="card mb-5">
            <div class="card-body pt-3">
                ...
                <form method="post" action="{{ route('processEditOwner', ['id' => $owner->id]) }}" novalidate
                    enctype="multipart/form-data">
                    @csrf
                    <!-- ... Form input fields ... -->
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <a href="/manage-owner" class="btn btn-outline-danger">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="nohp" value="{{ $owner->nohp }}"
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 d-flex justify-content-center">
                            <img id="preview-image" src="{{ Storage::url($owner->foto_profil) }}"

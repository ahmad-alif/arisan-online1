...
<head>
    ...
    <title>Daftar sebagai pemilik arisan | Arisanku</title>
...
<body>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Daftar sebagai pemilik</p>

                        <form class="mb-3" id="formregisterowner" enctype="multipart/form-data"
                            action="{{ route('register.processOwner') }}" method="POST" novalidate>
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nohp" name="nohp"
                                        class="form-control multi-steps-mobile" placeholder="81393476502" required
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var form = document.getElementById('formregisterowner');
